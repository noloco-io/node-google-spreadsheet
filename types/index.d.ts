...
export class GoogleSpreadsheet implements SpreadsheetBasicProperties {
	...
	_getDeveloperMetadata(
		dataFilter:
			| {
					developerMetadataLookup: { metadataKey?: string; metadataValue?: string };
			  }
			| { a1Range: string }
	): Promise<{ developerMetadata: DeveloperMetadata }[] | undefined>;
	getMetadataById(id: number): Promise<DeveloperMetadata>;
